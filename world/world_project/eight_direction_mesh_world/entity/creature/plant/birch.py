...
from world.world_project.eight_direction_mesh_world.entity.obj.fruit import Fruit
from world.world_project.eight_direction_mesh_world.entity.obj.wood import Wood
